...
A React application for tracking and analyzing policy bills, originally built on CREAO.ai platform.

## Description

This app provides tools for tracking legislative bills, policy documents, and related political information.
...
- Changed dev port to 3002 to avoid conflicts
